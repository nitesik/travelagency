...
export default function HomePageComponent() {
  return (
    <main className="min-h-screen ">
      ...
      >
        <div className="xl:w-[1200px] flex flex-col gap-14">
          <div className="lg:text-5xl text-white font-semibold text-center mt-[100px] grid gap-10 ">
            <h1>
          ...
          <div className="w-full flex justify-between mt-[75px]  ">
            {siteConfig.imageGroupOne().map((image, index) => (
              <div
                key={index}
                className="w-[24%] rounded-xl overflow-hidden  h-[300px] "
              >
                <div
      ...
      <div className="flex justify-center mt-[60px]">
        <div className="xl:w-[1200px]">
          ...
          <div className="w-full mt-[50px] flex justify-between">
            <div className="w-[30%] text-center flex items-center flex-col gap-5">
              <Image
            ...
            <div className="w-[30%] text-center flex items-center flex-col gap-3">
      ...
      <div className="flex justify-center my-[75px]">
        <div className="xl:w-[1200px] bg-secondary h-fit py-10 px-12 text-center leading-[40px] gap-5 text-xl text-white font-medium rounded-xl flex flex-col items-center">
          <Image
      ...
      <div className="flex justify-center my-[50px]">
        <div className="xl:w-[1200px] bg-tertiary flex flex-col items-center h-fit py-10 px-12 rounded-xl text-center leading-[40px] gap-5 text-xl font-medium ">
      ...
      <div className="flex justify-center">
        <div className="xl:w-[1200px] flex border  border-[#E5E5E5] p-10 rounded-3xl">
